...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(alphanumeric.replaceAll("[aei]","I replace the letter here"));
        ...
        System.out.println("==================================================");
        String anotherAlphanumeric = "abcDeeeF12Ghiiiijkl99z";
        System.out.println(anotherAlphanumeric.replaceAll("h+i*j","Y"));
